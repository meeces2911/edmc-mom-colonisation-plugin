...
class MockHTTPResponse:
    ...
    def status_code(self) -> int:
        res = MOCK_HTTP_RESPONSE_CODES.pop(0) if len(MOCK_HTTP_RESPONSE_CODES) > 0 else requests.codes.not_implemented
        logger.debug(f'MockHTTPResponse::status_code returning: {res}')
        return res
...
def _add_mocked_http_response(responseBody: str | None, responseCode: int = requests.codes.OK):
...
def test_journal_entry_ColonisationConstructionDepot():
    ...
    assert req[1] == {'range': "'SCS Offload'!A:A", 'majorDimension': 'ROWS', 'values': [[['aluminium', 'M7 Sector CG-X d1-90', -18, True, '2025-04-13T04:17:39Z'], ['ceramiccomposites', 'M7 Sector CG-X d1-90', -13, True, '2025-04-13T04:17:39Z'], ['cmmcomposite', 'M7 Sector CG-X d1-90', 38, True, '2025-04-13T04:17:39Z'], ['copper', 'M7 Sector CG-X d1-90', -5, True, '2025-04-13T04:17:39Z'], ['foodcartridges', 'M7 Sector CG-X d1-90', 2, True, '2025-04-13T04:17:39Z'], ['insulatingmembrane', 'M7 Sector CG-X d1-90', -17, True, '2025-04-13T04:17:39Z'], ['liquidoxygen', 'M7 Sector CG-X d1-90', 23, True, '2025-04-13T04:17:39Z'], ['medicaldiagnosticequipment', 'M7 Sector CG-X d1-90', 1, True, '2025-04-13T04:17:39Z'], ['polymers', 'M7 Sector CG-X d1-90', -14, True, '2025-04-13T04:17:39Z'], ['semiconductors', 'M7 Sector CG-X d1-90', -2, True, '2025-04-13T04:17:39Z'], ['steel', 'M7 Sector CG-X d1-90', 166, True, '2025-04-13T04:17:39Z'], ['superconductors', 'M7 Sector CG-X d1-90', 3, True, '2025-04-13T04:17:39Z'], ['titanium', 'M7 Sector CG-X d1-90', -16, True, '2025-04-13T04:17:39Z'], ['water', 'M7 Sector CG-X d1-90', 60, True, '2025-04-13T04:17:39Z'], ['waterpurifiers', 'M7 Sector CG-X d1-90', -1, True, '2025-04-13T04:17:39Z']]]}
